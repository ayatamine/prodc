            ...
            <div class="bg-white rounded ">
                ...
                <div class="flex justify-center gap-2 p-6">
                    <div class="w-full md:w-1/3 flex flex-col items-center justify-center">
                        ...
                        <!--add new project  -->
                        @professional
                        <a href="{{route('services.index')}}" class="outline-btn flex justify-start gap-x-2 mt-2 mx-auto">
                        ...
                        @else
                        <a href="{{route('services.create')}}" class="outline-btn flex justify-start gap-x-2 mt-2 mx-auto">
                            <svg class="h-5 w-5 " viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <line x1="12" y1="5" x2="12" y2="19" />
                                <line x1="5" y1="12" x2="19" y2="12" />
