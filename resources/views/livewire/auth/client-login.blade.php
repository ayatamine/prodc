@section('title','تسجيل الدخول للعملاء')
...
<div class=" bg-body p-6 py-16 md:py-16 px-8">
    ...
    <div class="lg:flex my-3 bg-white rounded shadow-lg overflow-hidden mx-auto max-w-5xl lg:max-w-7xl">
        ...
        <div class="w-full border-l  lg:w-1/3 bg-cover text-center md:flex md:flex-col justify-center p-16 lg:p-0">
            <img wire:ignore data-placeholder-background="#81929c" data-src="{{asset('assets/images/logo/logonew.jpg')}}" 

            class="lozad h-64 w-64 drop-shadow-md mx-auto"
            ...
            <a href="" @click.prevent=""
                ...
                <span> قم بتسجيل دخولك</span>
                <svg class="h-6 w-6 mr-2 " width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
        ...
        <div class="w-full p-8 md:px-16 lg:w-2/3">
            ...
            <p class="text-xl text-primaryTextColor font-semibold text-center leading-tight"> لتسجيل دخولك كعميل يمكنك استعمال</p>
            <div class="flex justify-center gap-x-3   lg:grid-cols-3 gap-3 my-4">
                ...
                <a href="#"
                    class="flex items-center justify-center my-2 text-white   h-12 w-12 md:h-auto md:w-auto rounded-full  border shadow-md hover:bg-gray-100">
                    <div class="md:p-1 ">
                        <svg class="h-11 w-11  " xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48"
                    ...
                    <h1 class="hidden px-3 py-2 w-5/6 text-start text-gray-600 font-bold text-sm md:text-smd"> فيسبوك
                    </h1>
                </a>
                <a href="#"
                    class="flex items-center justify-center my-2 text-white   h-12 w-12 md:h-auto md:w-auto rounded-full  border shadow-md hover:bg-gray-100">
                    ...
                    <h1 class="hidden px-3 py-2 w-5/6 text-start text-gray-600 font-bold text-sm md:text-smd"> تويتر
                    </h1>
                </a>
            </div>
            <div class="my-6 flex items-center justify-between">
                <span class="border-b w-1/5 lg:w-1/4"></span>
                <span class="text-sm text-center text-gray-500 uppercase">أو قم بتسجيل دخولك بالبريد</span>
                <span class="border-b w-1/5 lg:w-1/4"></span>
            </div>
            <form wire:submit.prevent="login" class="border p-3">
                <div class="email  mt-4">
                    <label for="email" class=" my-2 flex  text-sm md:text-base">
                        <span>البريد الالكتروني</span>
                        <span class="text-red-600 text-xl font-bold mr-2">*</span>
                    </label>
                    <input wire:model.lazy="email" type="email" class="white-input-theme" required value="" />
                    @error('email')
                ...
                <div class="flex items-center gap-2 text-sm md:text-md  mt-5">
                    <input wire:model.lazy="remember" type="checkbox" name="remember" id="remember"
                ...
                <div class="flex items-center gap-2 text-sm md:text-md  mt-5">
                    <input wire:model.lazy="conditions" type="checkbox" name="conditions" id="conditions"
                        class="border-gray-300 rounded h-5 md:h-4 w-5 md:w-4" />
                    <label for="conditions">ألتزم أن أكون أمينا و محسنا </label>
                    @error('conditions')
                    <p class="mt-2 text-sm text-red-600 flex-none">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mt-8">
                    <button type="submit"
                        ...
                        class="g-recaptcha  block text-center bg-primaryTextColor text-sm md:text-md text-white font-bold py-2 px-4 w-full rounded hover:bg-primaryTextColorDarken">
                        <svg wire:loading wire:target="login" class="
                                w-5
                                h-5
                                mr-3
                                -ml-1
            ...
            <div class="mt-4 flex items-center justify-between text-primaryTextColor font-semibold">
                ...
                <a href="{{route('register')}}" class="text-sm  uppercase"> <span class="text-gray-700 mx-1">لديك حساب؟
                    </span>حساب جديد</a>
                <span class="border-b w-1/6 md:w-1/4"></span>
            </div>
            <div class="mt-4 flex items-center justify-between text-red-600 font-semibold">
                <span class="border-b w-1/6 md:w-1/4"></span>
                <a href="{{route('clients.login')}}" class="text-sm  uppercase"> 
                    <span class="text-gray-700 mx-1">حساب محترف
                    </span>تسجيل دخول كمحترف</a>
                <span class="border-b w-1/6 md:w-1/4"></span>
            </div>
